...
use crate::models;
use crate::models::string_number::StringNumber;
...
pub struct OrderItem {
    ...
    pub order_item_id: StringNumber,
...
impl OrderItem {
    /// A single order item.
    pub fn new(asin: String, order_item_id: StringNumber, quantity_ordered: i32) -> OrderItem {
        OrderItem {
            asin,
            seller_sku: None,
            order_item_id,
